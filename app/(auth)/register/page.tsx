...
export default function Page() {
  ...
  return (
    <>
      <h1 className="text-2xl font-semibold tracking-tight text-center">Criar conta</h1>
      <p className="text-sm text-muted-foreground text-center">Comece gratuitamente</p>
