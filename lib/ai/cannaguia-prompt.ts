export const SYSTEM_PROMPT = [
  ...
  "",
  "FORMATO:",
  "- Responda com o tamanho que o assunto pedir. Perguntas simples = resposta curta. Perguntas complexas = resposta completa.",
  "- Use paragrafos curtos (2-3 frases) intercalados com bullets. Nao faça um bloco unico de texto.",
